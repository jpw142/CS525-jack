...
```
git clone https://github.com/hwxi/CS525-2026-Spring
```
...
https://github.com/hwxi/CS525-2026-Spring-hwxi

Then please mirror-push the class repo into your own repo:

```
cd CS525-2026-Spring
git push --mirror https://github.com/hwxi/CS525-2026-Spring-hwxi
git clone https://github.com/hwxi/CS525-2026-Spring-hwxi
cd CS525-2026-Spring-hwxi
git remote add upstream https://hwxi@github.com/hwxi/CS525-2026-Spring.git
```
