...
A complex program using tuples, recursion, strings, and print.
Encodes the board as nested pairs and solves via backtracking.
Expected: Produces all 92 solutions to the 8-queens problem.
"""
##################################################################
...
############################################################
print("=== test_queens: 8-Queens Puzzle ===")
print("Type-checking queens program...")
t = dexp_tinfer(queens_program)
print("tinfer(queens) = " + str(t))  # int

print("Transpiling to JS...")
js_code = dexp_trx2js(queens_program)
full_js = "var result = " + js_code + ';\nconsole.log("Total solutions: " + result);\n'
with open("TEST/test_queens.js", "w") as f:
    f.write(full_js)
print("Written to TEST/test_queens.js (" + str(len(js_code)) + " chars)")
print("Expected output: 92 solutions printed, then 'Total solutions: 92'")
